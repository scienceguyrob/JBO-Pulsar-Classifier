...
public class Logging
{
	 ...
	 */
	private static String LOG_PATH = System.getProperty("user.dir")+File.separatorChar+"jbpst.log";

	/**
	 * Path to the error log file this application will write to.
	 */
	private static String ERROR_PATH = System.getProperty("user.dir")+File.separatorChar+"jbpst.elog";
